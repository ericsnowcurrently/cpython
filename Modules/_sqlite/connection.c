...
final_callback(sqlite3_context *context)
{
    ...
    function_result = _PyObject_CallMethodIdNoArgs(*aggregate_instance, (_Py_Identifier *)&_Py_ID(finalize));
...
/*[clinic end generated code: output=5be05ae01ee17ee4 input=fbd17c75c7140271]*/
{
    ...
    cursor = _PyObject_CallMethodIdNoArgs((PyObject*)self, (_Py_Identifier *)&_Py_ID(cursor));
    if (!cursor) {
        goto error;
    }

    result = _PyObject_CallMethodIdObjArgs(cursor, (_Py_Identifier *)&_Py_ID(execute), sql, parameters, NULL);
    if (!result) {
        Py_CLEAR(cursor);
    }
...
/*[clinic end generated code: output=776cd2fd20bfe71f input=4feab80659ffc82b]*/
{
    ...
    result = _PyObject_CallMethodIdObjArgs(cursor, (_Py_Identifier *)&_Py_ID(executemany), sql,
                                           parameters, NULL);
    if (!result) {
        Py_CLEAR(cursor);
    }
...
/*[clinic end generated code: output=4c4f9d77aa0ae37d input=b27ae5c24ffb8b43]*/
{
    ...
    result = _PyObject_CallMethodIdObjArgs(cursor, (_Py_Identifier *)&_Py_ID(executescript),
                                           script_obj, NULL);
    if (!result) {
        Py_CLEAR(cursor);
    }
...
/*[clinic end generated code: output=586997aaf9808768 input=53bc907cb5eedb85]*/
{
    ...
    pyfn_iterdump = _PyDict_GetItemIdWithError(module_dict, (_Py_Identifier *)&_Py_ID(_iterdump));
    if (!pyfn_iterdump) {
        if (!PyErr_Occurred()) {
            PyErr_SetString(self->OperationalError,
