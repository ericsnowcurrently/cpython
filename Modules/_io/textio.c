...
/*[clinic end generated code: output=fbd04d443e764ec2 input=89db6b19c6b126bf]*/
{
    ...
    if (errors == NULL) {
        self->errors = _PyUnicode_FromId((_Py_Identifier *)&_Py_ID(strict));
        if (self->errors == NULL)
            return -1;
    }
    else {
...
/*[clinic end generated code: output=c10c622508b576cb input=c53fb505a76dbbe2]*/
{
    ...
    if (self->decoder != Py_None)
        return _PyObject_CallMethodId(self->decoder,
                                      (_Py_Identifier *)&_Py_ID(setstate), "((OK))", buffer, flag);
    else
        Py_RETURN_NONE;
}
                           ...
                           const char *errors)
{
    ...
    res = _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(readable));
    if (res == NULL)
        return -1;
                           ...
                           const char *errors)
{
    ...
    res = _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(writable));
    if (res == NULL)
        return -1;
    ...
    if (_PyObject_LookupAttrId(codec_info, (_Py_Identifier *)&_Py_ID(name), &res) < 0) {
        return -1;
    }
...
/*[clinic end generated code: output=72267c0c01032ed2 input=77d8696d1a1f460b]*/
{
    ...
    if (errors == Py_None) {
        errors = _PyUnicode_FromId((_Py_Identifier *)&_Py_ID(strict)); /* borrowed */
        if (errors == NULL) {
            return -1;
        }
    }
    ...
    if (encoding == NULL) {
        ...
        if (state == NULL)
            goto error;
        fileno = _PyObject_CallMethodIdNoArgs(buffer, (_Py_Identifier *)&_Py_ID(fileno));
    ...
    {
        if (_PyObject_LookupAttrId(buffer, (_Py_Identifier *)&_Py_ID(raw), &raw) < 0)
            goto error;
    ...
    res = _PyObject_CallMethodIdNoArgs(buffer, (_Py_Identifier *)&_Py_ID(seekable));
    if (res == NULL)
        goto error;
    r = PyObject_IsTrue(res);
    Py_DECREF(res);
                              ...
                              PyObject *errors, int newline_changed)
{
    ...
    if (encoding == Py_None) {
        ...
        errors = _PyUnicode_FromId((_Py_Identifier *)&_Py_ID(strict));
        if (errors == NULL) {
            return -1;
        }
    }
...
/*[clinic end generated code: output=d2deb0d50771fcec input=fdf19153584a0e44]*/
{
    ...
    if (haslf && self->writetranslate && self->writenl != NULL) {
        PyObject *newtext = _PyObject_CallMethodId(
            text, (_Py_Identifier *)&_Py_ID(replace), "ss", "\n", self->writenl);
        Py_DECREF(text);
        if (newtext == NULL)
            return NULL;
        text = newtext;
    ...
    if (self->decoder) {
        ret = _PyObject_CallMethodIdNoArgs(self->decoder, (_Py_Identifier *)&_Py_ID(reset));
        if (ret == NULL)
            return NULL;
        Py_DECREF(ret);
    }
...
/*[clinic end generated code: output=7e651ce6cc6a25a6 input=123eecbfe214aeb8]*/
{
    ...
    if (n < 0) {
        /* Read everything */
        PyObject *bytes = _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(read));
        PyObject *decoded;
        if (bytes == NULL)
            goto fail;
...
_textiowrapper_decoder_setstate(textio *self, cookie_type *cookie)
{
    ...
    */
    if (cookie->start_pos == 0 && cookie->dec_flags == 0)
        ...
        res = _PyObject_CallMethodId(self->decoder, (_Py_Identifier *)&_Py_ID(setstate),
                                     "((yi))", "", cookie->dec_flags);
    if (res == NULL)
        return -1;
    Py_DECREF(res);
...
/*[clinic end generated code: output=0a15679764e2d04d input=0458abeb3d7842be]*/
{
    ...
    case SEEK_CUR:
         ...
         */
        Py_DECREF(cookieObj);
        cookieObj = _PyObject_CallMethodIdNoArgs((PyObject *)self, (_Py_Identifier *)&_Py_ID(tell));
        if (cookieObj == NULL)
            goto fail;
        break;
    ...
    case SEEK_END:
        ...
        res = _PyObject_CallMethodIdNoArgs((PyObject *)self, (_Py_Identifier *)&_Py_ID(flush));
        if (res == NULL)
            goto fail;
        Py_DECREF(res);
        ...
        Py_CLEAR(self->snapshot);
        if (self->decoder) {
            res = _PyObject_CallMethodIdNoArgs(self->decoder, (_Py_Identifier *)&_Py_ID(reset));
            if (res == NULL)
                goto fail;
            Py_DECREF(res);
        }

        res = _PyObject_CallMethodId(self->buffer, (_Py_Identifier *)&_Py_ID(seek), "ii", 0, 2);
        Py_CLEAR(cookieObj);
        if (res == NULL)
            goto fail;
        if (self->encoder) {
    ...
    if (cookie.chars_to_skip) {
        ...
        PyObject *input_chunk = _PyObject_CallMethodId(
            self->buffer, (_Py_Identifier *)&_Py_ID(read), "i", cookie.bytes_to_feed);
        PyObject *decoded;
        ...
        decoded = _PyObject_CallMethodIdObjArgs(self->decoder, (_Py_Identifier *)&_Py_ID(decode),
...
/*[clinic end generated code: output=4f168c08bf34ad5f input=9a2caf88c24f9ddf]*/
{
    ...
    posobj = _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(tell));
    if (posobj == NULL)
        goto fail;
...
#define DECODER_DECODE(start, len, res) do { \
        PyObject *_decoded = _PyObject_CallMethodId( \
            self->decoder, (_Py_Identifier *)&_Py_ID(decode), "y#", start, len); \
    ...
    if (input == input_end) {
        ...
        PyObject *decoded = _PyObject_CallMethodId(
            self->decoder, (_Py_Identifier *)&_Py_ID(decode), "yO", "", /* final = */ Py_True);
        if (check_decoded(decoded) < 0)
            goto fail;
    ...
    res = _PyObject_CallMethodIdOneArg(self->decoder, (_Py_Identifier *)&_Py_ID(setstate), saved_state);
...
textiowrapper_repr(textio *self)
{
    ...
    if (_PyObject_LookupAttrId((PyObject *) self, (_Py_Identifier *)&_Py_ID(name), &nameobj) < 0) {
    ...
    if (_PyObject_LookupAttrId((PyObject *) self, (_Py_Identifier *)&_Py_ID(mode), &modeobj) < 0) {
        goto error;
    }
    if (modeobj != NULL) {
...
{
    CHECK_ATTACHED(self);
    return _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(fileno));
}
...
{
    CHECK_ATTACHED(self);
    return _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(seekable));
}
...
{
    CHECK_ATTACHED(self);
    return _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(readable));
}
...
{
    CHECK_ATTACHED(self);
    return _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(writable));
}
...
{
    CHECK_ATTACHED(self);
    return _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(isatty));
}
...
/*[clinic end generated code: output=59de9165f9c2e4d2 input=928c60590694ab85]*/
{
    ...
    if (_textiowrapper_writeflush(self) < 0)
        return NULL;
    return _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(flush));
}
    ...
    if (r > 0) {
        ...
        if (self->finalizing) {
            res = _PyObject_CallMethodIdOneArg(self->buffer,
                                              (_Py_Identifier *)&_Py_ID(_dealloc_warn),
                                              (PyObject *)self);
            if (res)
                Py_DECREF(res);
            else
        ...
        res = _PyObject_CallMethodIdNoArgs(self->buffer, (_Py_Identifier *)&_Py_ID(close));
        if (exc != NULL) {
...
{
    CHECK_ATTACHED(self);
    return _PyObject_GetAttrId(self->buffer, (_Py_Identifier *)&_Py_ID(name));
}
