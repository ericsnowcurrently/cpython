...
/*[clinic end generated code: output=6c3b8a78bc201c67 input=2725352806399cab]*/
{
    ...
    if (!PyFloat_CheckExact(number)) {
        PyObject *method = _PyObject_LookupSpecial(number, (_Py_Identifier *)&_Py_ID(__ceil__));
        if (method != NULL) {
...
/*[clinic end generated code: output=c6a65c4884884b8a input=63af6b5d7ebcc3d6]*/
{
    ...
    {
        PyObject *method = _PyObject_LookupSpecial(number, (_Py_Identifier *)&_Py_ID(__floor__));
        if (method != NULL) {
            PyObject *result = _PyObject_CallNoArgs(method);
            Py_DECREF(method);
            return result;
...
/*[clinic end generated code: output=34b9697b707e1031 input=2168b34e0a09134d]*/
{
    ...
    trunc = _PyObject_LookupSpecial(x, (_Py_Identifier *)&_Py_ID(__trunc__));
    if (trunc == NULL) {
        if (!PyErr_Occurred())
