...
#include "Python.h"
#include "pycore_interp.h"        // _PyInterpreterState.pythreads.num_threads
...
thread_run(void *boot_raw)
{
    ...
    tstate->interp->pythreads.num_threads++;
...
{
    PyInterpreterState *interp = _PyInterpreterState_GET();
    return PyLong_FromLong(interp->pythreads.num_threads);
}
