...
/*[clinic end generated code: output=41b43f0f0becafae input=359b6985f6489d2e]*/
{
    ...
    if (checkpath(path) || namespaces != Py_None) {
        ...
        return _PyObject_CallMethodIdObjArgs(
            st->elementpath_obj, (_Py_Identifier *)&_Py_ID(find), self, path, namespaces, NULL
            );
    }
...
/*[clinic end generated code: output=83b3ba4535d308d2 input=b53a85aa5aa2a916]*/
{
    ...
    if (checkpath(path) || namespaces != Py_None)
        return _PyObject_CallMethodIdObjArgs(
            st->elementpath_obj, (_Py_Identifier *)&_Py_ID(findtext),
...
/*[clinic end generated code: output=1a0bd9f5541b711d input=4d9e6505a638550c]*/
{
    ...
    if (checkpath(path) || namespaces != Py_None) {
        ...
        return _PyObject_CallMethodIdObjArgs(
            st->elementpath_obj, (_Py_Identifier *)&_Py_ID(findall), self, path, namespaces, NULL
            );
    }
...
/*[clinic end generated code: output=ecdd56d63b19d40f input=abb974e350fb65c7]*/
{
    ...
    return _PyObject_CallMethodIdObjArgs(
        st->elementpath_obj, (_Py_Identifier *)&_Py_ID(iterfind), self, tag, namespaces, NULL);
}
...
treebuilder_flush_data(TreeBuilderObject* self)
{
    ...
    if (!self->last_for_tail) {
        ...
        return treebuilder_extend_element_text_or_tail(
                element, &self->data,
                &((ElementObject *) element)->text, (_Py_Identifier *)&_Py_ID(text));
    }
    else {
        ...
        return treebuilder_extend_element_text_or_tail(
                element, &self->data,
                &((ElementObject *) element)->tail, (_Py_Identifier *)&_Py_ID(tail));
    }
}
...
treebuilder_add_subelement(PyObject *element, PyObject *child)
{
    ...
    if (Element_CheckExact(element)) {
        ...
        PyObject *res;
        res = _PyObject_CallMethodIdOneArg(element, (_Py_Identifier *)&_Py_ID(append), child);
        if (res == NULL)
            return -1;
        Py_DECREF(res);
        return 0;
                            ...
                            int has_internal_subset)
{
    ...
    else if (_PyObject_LookupAttrId((PyObject *)self, (_Py_Identifier *)&_Py_ID(doctype), &res) > 0) {
