...
PyObject_LengthHint(PyObject *o, Py_ssize_t defaultvalue)
{
    ...
    hint = _PyObject_LookupSpecial(o, (_Py_Identifier *)&_Py_ID(__length_hint__));
    if (hint == NULL) {
        if (PyErr_Occurred()) {
            return -1;
        }
...
PyObject_GetItem(PyObject *o, PyObject *key)
{
    ...
    if (PyType_Check(o)) {
        ...
        if (_PyObject_LookupAttrId(o, (_Py_Identifier *)&_Py_ID(__class_getitem__), &meth) < 0) {
            return NULL;
        }
        if (meth) {
...
PyObject_Format(PyObject *obj, PyObject *format_spec)
{
    ...
    meth = _PyObject_LookupSpecial(obj, (_Py_Identifier *)&_Py_ID(__format__));
    if (meth == NULL) {
        PyThreadState *tstate = _PyThreadState_GET();
        if (!_PyErr_Occurred(tstate)) {
...
PyNumber_Long(PyObject *o)
{
    ...
    trunc_func = _PyObject_LookupSpecial(o, (_Py_Identifier *)&_Py_ID(__trunc__));
    if (trunc_func) {
...
PyMapping_Keys(PyObject *o)
{
    ...
    return method_output_as_list(o, (_Py_Identifier *)&_Py_ID(keys));
}
...
PyMapping_Items(PyObject *o)
{
    ...
    return method_output_as_list(o, (_Py_Identifier *)&_Py_ID(items));
}
...
PyMapping_Values(PyObject *o)
{
    ...
    return method_output_as_list(o, (_Py_Identifier *)&_Py_ID(values));
}
...
abstract_get_bases(PyObject *cls)
{
    ...
    (void)_PyObject_LookupAttrId(cls, (_Py_Identifier *)&_Py_ID(__bases__), &bases);
...
object_isinstance(PyObject *inst, PyObject *cls)
{
    ...
    if (PyType_Check(cls)) {
        ...
        if (retval == 0) {
            retval = _PyObject_LookupAttrId(inst, (_Py_Identifier *)&_Py_ID(__class__), &icls);
            if (icls != NULL) {
...
object_recursive_isinstance(PyThreadState *tstate, PyObject *inst, PyObject *cls)
{
    ...
    PyObject *checker = _PyObject_LookupSpecial(cls, (_Py_Identifier *)&_Py_ID(__instancecheck__));
    if (checker != NULL) {
        if (_Py_EnterRecursiveCall(tstate, " in __instancecheck__")) {
            Py_DECREF(checker);
            return -1;
...
object_issubclass(PyThreadState *tstate, PyObject *derived, PyObject *cls)
{
    ...
    checker = _PyObject_LookupSpecial(cls, (_Py_Identifier *)&_Py_ID(__subclasscheck__));
    if (checker != NULL) {
        int ok = -1;
        if (_Py_EnterRecursiveCall(tstate, " in __subclasscheck__")) {
            Py_DECREF(checker);
...
PyIter_Send(PyObject *iter, PyObject *arg, PyObject **result)
{
    ...
    if (arg == Py_None && PyIter_Check(iter)) {
        ...
        *result = _PyObject_CallMethodIdOneArg(iter, (_Py_Identifier *)&_Py_ID(send), arg);
    }
    if (*result != NULL) {
        return PYGEN_NEXT;
    }
