...
dict_subscript(PyDictObject *mp, PyObject *key)
{
    ...
    if (ix == DKIX_EMPTY || value == NULL) {
        if (!PyDict_CheckExact(mp)) {
            ...
            missing = _PyObject_LookupSpecial((PyObject *)mp, (_Py_Identifier *)&_Py_ID(__missing__));
            if (missing != NULL) {
...
dictviews_sub(PyObject *self, PyObject *other)
{
    ...
    PyObject *tmp = _PyObject_CallMethodIdOneArg(
            result, (_Py_Identifier *)&_Py_ID(difference_update), other);
    if (tmp == NULL) {
        Py_DECREF(result);
        return NULL;
    }
...
_PyDictView_Intersect(PyObject* self, PyObject *other)
{
    ...
    if (PySet_CheckExact(other) && len_self <= PyObject_Size(other)) {
        ...
        return _PyObject_CallMethodIdObjArgs(other, (_Py_Identifier *)&_Py_ID(intersection), self, NULL);
    }
...
dictviews_xor(PyObject* self, PyObject *other)
{
    ...
    PyObject *tmp = _PyObject_CallMethodIdOneArg(
            result, (_Py_Identifier *)&_Py_ID(symmetric_difference_update), other);
    if (tmp == NULL) {
        Py_DECREF(result);
        return NULL;
    }
