...
PyStatus
_PyTypes_Init(PyInterpreterState *interp)
{
...
#define INIT_TYPE(TYPE, NAME) \
    ...
    INIT_TYPE(PyContextToken_Type, ContextTokenType);
    INIT_TYPE(PyContextVar_Type, ContextVarType);
    INIT_TYPE(PyContext_Type, ContextType);
    ...
    INIT_TYPE(_PyHamt_ArrayNode_Type, _Hamt_ArrayNodeType);
    INIT_TYPE(_PyHamt_BitmapNode_Type, _Hamt_BitmapNodeType);
    INIT_TYPE(_PyHamt_CollisionNode_Type, _Hamt_CollisionNodeType);
    INIT_TYPE(_PyHamt_Type, _HamtType);
...
#define INIT_ADAPTER(NAME, KIND, TYPE) \
    ...
    INIT_ADAPTER(dict, items_iter, PyDictIterItem_Type);
    INIT_ADAPTER(dict, items_reversed, PyDictRevIterItem_Type);
    INIT_ADAPTER(dict, keys, PyDictKeys_Type);
    INIT_ADAPTER(dict, keys_iter, PyDictIterKey_Type);
    INIT_ADAPTER(dict, keys_reversed, PyDictRevIterKey_Type);
    INIT_ADAPTER(dict, values, PyDictValues_Type);
    INIT_ADAPTER(dict, values_iter, PyDictIterValue_Type);
    INIT_ADAPTER(dict, values_reversed, PyDictRevIterValue_Type);
    INIT_ADAPTER(list, iter, PyListIter_Type);
    INIT_ADAPTER(list, reversed, PyListRevIter_Type);
    INIT_ADAPTER(range, iter, PyRangeIter_Type);
    INIT_ADAPTER(set, iter, PySetIter_Type);
    INIT_ADAPTER(str, iter, PyUnicodeIter_Type);
    INIT_ADAPTER(tuple, iter, PyTupleIter_Type);
