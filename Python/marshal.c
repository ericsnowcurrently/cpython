...
r_string(Py_ssize_t n, RFILE *p)
{
    ...
    if (!p->readable) {
        ...
        res = _PyObject_CallMethodId(p->readable, (_Py_Identifier *)&_Py_ID(readinto), "N", mview);
        if (res != NULL) {
...
/*[clinic end generated code: output=aaee62c7028a7cb2 input=6c7a3c23c6fef556]*/
{
    ...
    if (s == NULL)
        return NULL;
    res = _PyObject_CallMethodIdOneArg(file, (_Py_Identifier *)&_Py_ID(write), s);
    Py_DECREF(s);
    return res;
}
...
/*[clinic end generated code: output=f8e5c33233566344 input=c85c2b594cd8124a]*/
{
     ...
     * for r_string()
     */
    data = _PyObject_CallMethodId(file, (_Py_Identifier *)&_Py_ID(read), "i", 0);
    if (data == NULL)
        return NULL;
