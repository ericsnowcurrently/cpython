...
The :mod:`!interpreters.channels` module constructs higher-level
interfaces on top of the lower level :mod:`!_interpchannels` module.

.. seealso::

   :ref:`execcomponents`
       how interpreters fit into Python's execution model

   :mod:`interpreters`
       provides details about communicating between interpreters.

.. XXX Add references to the upcoming HOWTO docs.
