...
.. note::
   ...
   Make sure concurrency is the right tool for the job
   before you reach for it when solving your problem.  In many
   cases, concurrency simply isn't applicable and only
